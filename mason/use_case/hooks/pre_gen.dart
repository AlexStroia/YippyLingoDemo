...
Future<void> run(HookContext context) async {
  ...
  context.vars = {
    ...
    "use_case_absolute_path":
        "$relativeRoot/lib/${featurePath}/domain/use_cases/$useCaseFileName",
    "failure_absolute_path":
        "$relativeRoot/lib/${featurePath}/domain/model/$failureFileName",
    "use_case_test_absolute_path":
        "$relativeRoot/test/${featurePath}/domain/${stem.snakeCase}_use_case_test.dart",
    "feature": featureName,
    "root_dir": rootDir,
  };
