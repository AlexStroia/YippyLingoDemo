...
class SomeFeaturePage extends StatefulWidget with HasPresenter<SomeFeaturePresenter> {
...
class _SomeFeaturePageState extends State<SomeFeaturePage> with PresenterStateMixin<SomeFeatureViewModel, SomeFeaturePresenter, SomeFeaturePage> {
